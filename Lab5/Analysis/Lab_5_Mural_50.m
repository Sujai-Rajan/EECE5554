%% Code for Mural with 50% overlap
close all; clear all;
...
for n = 2:numImages
    ...
    % Add a small constant to the diagonal elements to avoid singularity
    tforms(n).T = tforms(n).T + eye(3) * 1e-12;
...
%%
clearvars -except numImages buildingScene panoramaView blender panorama tforms  ;
%%
...
for i = 1:numImages
    ...
    I = imrotate(readimage(buildingScene, i),rotationAngle);  
